...
namespace RentEase.Service.Service.Main
{
    ...
    public class ContractService : BaseService<Contract, ResponseContractDto>, IContractService
    {
        ...
        public async Task<ServiceResult> GetAllForAptAsync(int aptId, bool? status, int page, int pageSize)
        {
            ...
            var items = await _unitOfWork.ContractRepository.GetAllForAptAsync(aptId, status, page, pageSize);
            if (!items.Data.Any())
            {
            ...
            {
                var responseData = _mapper.Map<IEnumerable<ResponseContractDto>>(items.Data);
